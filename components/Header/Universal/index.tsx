...
async function Mobile() {
  ...
  return (
    <div className="dropdown dropdown-end z-50 sm:hidden">
      ...
      <ul
        tabIndex={0}
        className="dropdown-content z-[1] min-w-[220px] origin-top-right rounded-lg bg-gray-100 p-1.5 shadow-lg mt-3"
      >
        {authed && (
          <>
            <li>
              <Link
                href={"/user/profile"}
                className="flex h-9 cursor-pointer items-center justify-between rounded-md px-2 text-sm text-gray-900 outline-none hover:bg-gray-300"
              >
                账号详情
                <svg
                  xmlns="http://www.w3.org/2000/svg"
