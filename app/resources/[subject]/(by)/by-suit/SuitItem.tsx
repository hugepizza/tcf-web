  ...
  return (
    <Dialog>
          ...
          <div className="flex flex-col gap-3 relative z-10">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Button
                ...
                size="sm"
                asChild
                className="inline-block rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center cursor-pointer bg-gradient-to-b from-white/[.105] to-white/[.15] backdrop-blur-[20px] text-gray-600 hover:text-gray-800 border border-gray-200/75"
      ...
      <DialogContent className="max-w-4xl h-[80vh] flex flex-col">
        {/* 新增的对话框内容 */}
        <div className="absolute rounded-t-lg inset-0 bg-gradient-to-b from-[#efe6fb] from-[-27.49%] to-transparent to-[70.36%] pointer-events-none -z-10" />
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-4 md:px-5 mb-8">
            <div className="flex items-start gap-3">
              ...
              <div className="max-w-md space-y-1">
                ...
                <p className="text-gray-600">此次测试只包含{subject}部分的问题，你需要在限时中完成作答。</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="max-w-md space-y-1">
                ...
                <p className="text-gray-600">你可以中途退出练习，退出期间时间不会继续计算，你可以在做题记录中随时返回本次练习。</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="max-w-md space-y-1">
                ...
                <p className="text-gray-600">完成测试后，你可以查看详细的答案解析和测试报告。</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="max-w-md space-y-1">
                ...
                <p className="text-gray-600">所有题目均为选择题，类型只有单选，越靠后的题目难度越高，单位记分也越大。</p>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="flex justify-center gap-3 mt-auto pt-4 border-t bg-white">
          <form action={() => startPracticeBySuit(suit.id)}>
            <Button 
              type="submit"
